...
// import profile from "@/screens/profile.png"
// import comming from "@/screens/comming.png"
    ...
    >
      ...
      >
        {carouselItems.map((item, index) => {
          ...
          // src="
          alt="Project preview"
          className="object-cover h-60 w-full transition-transform  duration-500 group-hover:scale-110 z-0"
        />
              {/* </div> */}
            </motion.div>
          );
